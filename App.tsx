...
export default function App() {
  ...
  const handleExportCSV = () => {
    // 1. Definir Cabeceras (ACTUALIZADO CON NUEVAS COLUMNAS)
    const headers = [
      ...
      // Protecciones B1 / Rápida
      'Fusibles G1 (A)', 'Térmico Min G1', 'Térmico Max G1', 'Regulado G1',
      // Protecciones B2 / Lenta
      'Fusibles G2 (A)', 'Térmico Min G2', 'Térmico Max G2', 'Regulado G2',
      // Flag Variador
      'Tiene Variador'
    ];
    ...
    const rows = data.map(item => {
      ...
      return [
        ...
        r.vibrationSlow || '',
        // Grupo 1
        r.fuses1 || r.fuses || '', // Fallback antiguo fuses
        r.thermalMin1 || r.thermalMin || '',
        r.thermalMax1 || r.thermalMax || '',
        r.regulated1 || r.regulated || '',
        // Grupo 2
        r.fuses2 || '',
        r.thermalMin2 || '',
        r.thermalMax2 || '',
